...
public class AlertServiceImpl extends TransactionalService implements AlertService {
        ...
        try {
            ...
            if (alertOptional.isPresent()) {
                ...
                if (alert.getThreshold() != null) {
                    alertToUpdate.setThreshold(alert.getThresholdType().name());
                }
                alertToUpdate.setValue(alert.getThreshold());
    ...
    private Alert convert(final NewAlertEntity alertEntity) {
        ...
        if (alertEntity.getThresholdType() != null) {
            alert.setThreshold(alertEntity.getThresholdType().name());
        }
        alert.setValue(alertEntity.getThreshold());
    ...
    private AlertEntity convert(final Alert alert) {
        ...
        if (alert.getThreshold() != null) {
            alertEntity.setThresholdType(ThresholdType.valueOf(alert.getThreshold()));
        }
        if (alert.getValue() != null) {
            alertEntity.setThreshold(alert.getValue());
        }
